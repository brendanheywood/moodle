...
$string['debugcachelocks'] = 'Debug cache locks';
$string['debugcachelocks_desc'] = 'Log cache lock wait and hold times that exceed this threshold (in seconds, eg 0.2) Leave empty to disable logging.';
