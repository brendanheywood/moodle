...
$string['configcountry'] = 'If you set a country here, then this country will be selected by default on new user accounts. If no default is set then the users country and city will be looked up from their IP address where possible.';
