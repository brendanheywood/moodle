...
$string['task_host_concurrency_limit'] = 'Per host task concurrency limit';
$string['task_host_concurrency_limit_desc'] = 'The maximum number of tasks, either scheduled or adhoc, that can be run concurrently on the same host. If 0 then unlimited.';
