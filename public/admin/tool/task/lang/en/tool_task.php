...
$string['deleteadhoclocked'] = 'Ad hoc task was locked, likely already running';
$string['deleteadhocnotfound'] = 'Ad hoc task was not found, likely already run';
$string['deleteadhocsuccess'] = 'Ad hoc task was deleted';
