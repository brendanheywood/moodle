...
$string['bouncehandler'] = 'Handles incoming bounce emails.';
$string['bouncehandlername'] = 'Bounce handler';
...
$string['incomingmailbouncesettings'] = 'Bounced mail settings';
$string['incomingmailbouncesettings_desc'] = 'Moodle is capable of both sending out bounce messages and handling incoming bounce messages. If turned on this will override the noreply email address used in the Return-Path of all outgoing emails.';
...
$string['messageinboundbouncesenabled'] = 'Enable bounce handling';
$string['messageinboundbouncesenabled_desc'] = 'Note: This override the noreplyaddress';
$string['messageinboundbouncemin'] = 'Minimum bounces';
$string['messageinboundbouncemin_desc'] = 'More than this threshold of emails must bounce to be flagged';
$string['messageinboundbounceratio'] = 'Bounce ratio';
$string['messageinboundbounceratio_desc'] = 'More than this percentage of emails must bounce to be flagged';
