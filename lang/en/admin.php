...
$string['configpasswordpolicyatlogin'] = 'Should the password policy also be check at every login, and if it fails what should happen.';
...
$string['passwordpolicyatlogin'] = 'Check password policy at login';
