...
$string['configforcelogin'] = 'Normally, the site home and the course listings (but not courses) can be read by people without logging in to the site. If you want to force people to log in before they do ANYTHING on the site, then you should enable this setting. Note: User profile images are independently controlled via forceloginforprofileimage.';
...
$string['forceloginforprofileimage_help'] = 'If enabled, users must log in in order to view user profile pictures and the default user picture will be used in all notification emails. If disabled then user pictures are publicly visible including in emails, and this is independent of the value of forcelogin.';
