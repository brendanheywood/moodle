...
$string['forcedstoreactions'] = 'Stores forced in config.php cannot be modified';
$string['forcedmodemappings'] = 'Forced mode mappings';
$string['forcedmodemappings_help'] = 'Forced mode mappings in config.php cannot be modified';
