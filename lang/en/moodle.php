...
$string['emailresetyourpassword'] = 'Reset your password';
$string['emailresetintro'] = 'A password reset was requested for your account <code>{$a->username}</code> at {$a->sitename}.

To confirm this request, and set a new password for your account:';

$string['emailresethelp'] = 'This link is valid for {$a->resetminutes} minutes from the time this reset was first requested.
