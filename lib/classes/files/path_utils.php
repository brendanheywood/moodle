...
class path_utils {
     ...
     */
    static public function get_all_file_configs() {
        return [
            'dirroot',
            'dataroot',
     ...
     */
    static public function get_config_from_path(string $path, bool $deepest = false, bool $showother = false): string {
        global $CFG;
     ...
     */
    static public function redact_paths(string $message): string {
