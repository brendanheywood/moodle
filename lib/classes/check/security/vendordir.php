 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class vendordir extends security_check {
    ...
    public function __construct() {
        ...
        $this->details = get_string('check_vendordir_details', 'report_security', ['path' => $CFG->dirroot.'/vendor']);
        $this->summary = get_string('check_vendordir_info', 'report_security');
