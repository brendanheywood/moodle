 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class openprofiles extends security_check {
    ...
    public function __construct() {
        ...
        $this->details = get_string('check_openprofiles_details', 'report_security');
        ...
        if (empty($CFG->forcelogin) and empty($CFG->forceloginforprofiles)) {
            ...
            $this->summary = get_string('check_openprofiles_error', 'report_security');
        } else {
            $this->status = check::OK;
            $this->summary = get_string('check_openprofiles_ok', 'report_security');
        }
    }
}
