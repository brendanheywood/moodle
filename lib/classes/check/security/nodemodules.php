 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class nodemodules extends security_check {
    ...
    public function __construct() {
        ...
        $this->summary = get_string('check_nodemodules_info', 'report_security');
        $this->details = get_string('check_nodemodules_details', 'report_security', ['path' => $CFG->dirroot . '/node_modules']);
