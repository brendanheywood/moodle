...
class flexible_table {
     ...
     * download type.
     * @param string $download dataformat type. One of csv, tsv, xhtml, ods, etc
     * @param string $filename filename for downloads without file extension.
     * @param string $sheettitle title for downloaded data.
     * @return string download dataformat type. One of csv, tsv, xhtml, ods, etc
     */
    ...
    public function download_buttons() {
        ...
        if ($this->is_downloadable() && !$this->is_downloading()) {
            ...
            $html = $OUTPUT->download_dataformat_selector(get_string('downloadas', 'table'),
                    $this->baseurl->out_omit_querystring(), 'download', $params);
